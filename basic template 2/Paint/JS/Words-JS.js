...
dictionary_noun["shirt"] = "A long- or short-sleeved garment for the upper part of the body, usually lightweight and having a collar and a front opening.";
...
function getWord() {
    ...
    if(key in dictionary_noun) {
        definition = dictionary_noun[key];
        html_definition = document.getElementById("definition").value = definition;
        return definition;
    }
    else {
        alert("Don't have that word!");
    }
}
